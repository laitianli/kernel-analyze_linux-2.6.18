...
#define STS_PCD		(1<<2)		/* port change detect */	//端口出现插拨事件
#define STS_ERR		(1<<1)		/* "error" completion (overflow, ...) */ //事务执行出错
#define STS_INT		(1<<0)		/* "normal" completion (short, ...) */	//事务结束产生中断
...
#define PORT_OCC	(1<<5)		/* over current change *//*过电流变化*/
...
#define	QTD_TOGGLE	(1 << 31)	/* data toggle *//*数据切换*/
