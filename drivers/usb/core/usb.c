 ...
 */
/**ltl
功能:usb_bus_type总线的uevent处理函数,用来向udev发送usb插拨事件
*/
		      ...
		      char *buffer, int buffer_size)
{
	...
	//usb设备的dev不发送事件，因为一个usb设备的功能是由interface表示，因此只有interface的dev调用device_add才发送事件。
...
/**ltl
说明:总线驱动模型中，usb总线对象的定义。
*/
struct bus_type usb_bus_type = {
	.name =		"usb",
	.match =	usb_device_match,		//匹配设备与驱动的接口
	.uevent =	usb_uevent,				//usb设备插入时，通知用户空间的接口
	.suspend =	usb_generic_suspend,	//设备挂起接口
	.resume =	usb_generic_resume,		//设备唤醒接口
};
