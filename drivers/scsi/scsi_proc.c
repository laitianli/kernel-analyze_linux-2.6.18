...
/**ltl
功能:创建scsi host template proc目录项,分配一个proc_dir_entry对象
参数:sht	->
*/
...
/**ltl
功能:在/proc/scsi下创建文件，文件名为主机控制器编号(eg:/proc/scsi/usb-storage/6)
*/
...
/**ltl
功能:创建/proc/scsi文件。
说明:要通过/proc/scsi/访问设备信息时，就要在scsi_host_template对象实现proc_info函数。
*/
