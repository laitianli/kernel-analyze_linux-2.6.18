				       ...
				       unsigned long event, void *data)
{
	...
	if (!pr || !pr->performance)
		goto out;
	/* performance_platform_limit=0, state_count=11*/
...
static int acpi_processor_get_platform_limit(struct acpi_processor *pr)
{
	 ...
	 */
	/*(PPC-性能呈现功能)
	 *Performance Present Capabilites – returns a list of the performance states
	...
	pr->performance_platform_limit = (int)ppc; /*ppc=0*/
